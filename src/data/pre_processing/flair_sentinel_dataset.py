...
class FlairSentinelDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> tuple[torch.Tensor, torch.Tensor, str]:
        ...
        sentinel_data = self._load_sentinel_patch(feature_path)
        ...
        return sentinel_data, mask, sample_id

    def _load_sentinel_patch(self, feature_path: Path) -> torch.Tensor:
        ...
        if sp_masks_path is None:
            ...
            return torch.from_numpy(sentinel_patch).float()
        ...
        if self.use_monthly_average:
            ...
            sentinel_patch, _ = compute_monthly_averages(
                sentinel_patch,
                masks_patch,
                product_names,
                self.cloud_snow_cover_threshold,
